...
class EmergencyContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emergency_contact" do
    assert_difference('EmergencyContact.count') do
      post emergency_contacts_url, params: { emergency_contact: { contact_address: @emergency_contact.contact_address, name: @emergency_contact.name, relationship: @emergency_contact.relationship, student_id: @emergency_contact.student_id, telephone: @emergency_contact.telephone } }
    end
  ...
  test "should update emergency_contact" do
    patch emergency_contact_url(@emergency_contact), params: { emergency_contact: { contact_address: @emergency_contact.contact_address, name: @emergency_contact.name, relationship: @emergency_contact.relationship, student_id: @emergency_contact.student_id, telephone: @emergency_contact.telephone } }
